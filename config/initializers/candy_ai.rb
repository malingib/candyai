...
# Optional OpenAI-compatible providers are independent of the default provider.
# This allows an account to select a configured secondary provider even when
# the global default credentials are not present.
