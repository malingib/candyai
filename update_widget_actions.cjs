...
const oldRenderActions = `  function renderActions() {
    var html = "";
    if (!leadCaptured) {
      html +=
...
const newRenderActions = \`  function renderActions() {
    var html = "";
    ...
    if (waNum) {
      // Dynamic WhatsApp link with context if available
...
content = content.replace(oldRenderActions, newRenderActions);
